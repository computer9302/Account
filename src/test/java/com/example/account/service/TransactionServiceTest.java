...
class TransactionServiceTest {
    ...
    void successUseBalance() {
        ...
        given(transactionRepository.save(any()))
                .willReturn(Transaction.builder()
                        ...
                        .build());
        ArgumentCaptor<Transaction> capter = ArgumentCaptor.forClass(Transaction.class);
        //when
        TransactionDto transactionDto = transactionService.useBalance(1L,
                "1000000000", 200L);
        //then
        verify(transactionRepository, times(1)).save(capter.capture());


        assertEquals(200L, capter.getValue().getAmount());
        assertEquals(9800L, capter.getValue().getBalanceSnapshot());
    ...
    void deleteAccountFailed_alreadUnregistered() {
        //given
        AccountUser pobi = AccountUser.builder()
                .id(12L)
                .name("Pobi").build();
    ...
    public void saveFailedUseTransaction(String accountNumber, Long amount) {
        ...
        verify(transactionRepository, times(1)).save(capter.capture());
        assertEquals(200L, capter.getValue().getAmount());
        assertEquals(10000L, capter.getValue().getBalanceSnapshot());
        assertEquals(F, capter.getValue().getTransactionResultType());
    }
    ...
    void successCancelBalance() {
        ...
        assertEquals(CANCEL_AMOUNT, capter.getValue().getAmount());
        assertEquals(10000L + CANCEL_AMOUNT, capter.getValue().getBalanceSnapshot());
        assertEquals(S, transactionDto.getTransactionResultType());
